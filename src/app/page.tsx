  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        <div className="text-lg font-semibold text-red-200">Blacklist Revenue Lab</div>
      ...
      <main className="mx-auto grid max-w-6xl gap-12 px-6 pb-20">
        <section className="grid gap-6 md:grid-cols-[1.2fr,0.8fr] items-center">
          <div className="space-y-4">
            <h1 className="text-4xl font-semibold text-red-50">
              Turn raw ideas into revenue pipelines.
            </h1>
            <p className="text-lg text-red-200/70">
          ...
          <Card className="bg-black/70 border-red-900/40">
            <CardHeader>
              <CardTitle className="text-red-100">What you get</CardTitle>
            </CardHeader>
        ...
        <section className="grid gap-6 md:grid-cols-3">
          {[
            ...
            <Card key={feature.title} className="bg-black/70 border-red-900/40">
              <CardHeader>
                <CardTitle className="text-red-100">{feature.title}</CardTitle>
              </CardHeader>
              <CardContent className="text-sm text-red-200/70">{feature.body}</CardContent>
            </Card>
          ))}
        </section>
        ...
        <section className="grid gap-6 md:grid-cols-[1fr,1fr]">
          <Card className="bg-black/70 border-red-900/40">
            <CardHeader>
              <CardTitle className="text-red-100">Who it&apos;s for</CardTitle>
            </CardHeader>
          ...
          <Card className="bg-black/70 border-red-900/40">
            <CardHeader>
              <CardTitle className="text-red-100">Why teams stick</CardTitle>
            </CardHeader>
            <CardContent className="space-y-2 text-sm text-red-200/70">
        ...
        <section className="rounded-2xl border border-red-900/40 bg-black/70 p-8 text-center">
          <h2 className="text-2xl font-semibold text-red-50">Ready to build your revenue pipeline?</h2>
