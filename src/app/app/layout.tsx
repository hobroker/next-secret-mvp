  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      <header className="border-b border-red-900/40 px-6 py-4 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-4 text-xs text-red-200/70">
          <Link href="/app" className="hover:text-red-100">
            Dashboard
          </Link>
          <Link href="/app/opportunities" className="hover:text-red-100">
            Opportunities
          </Link>
